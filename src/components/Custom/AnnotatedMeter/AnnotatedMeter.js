...
var AnnotatedMeter = function (_Component) {
  ...
  (0, _createClass3.default)(AnnotatedMeter, [{
    ...
    value: function render() {
      ...
      var seconds = Math.floor((value * 60) - +minutes * 60).toString();

      value = ('00' + minutes).substring(minutes.length) + ":" + ('00' + seconds).substring(seconds.length);
      ...
      if (legend) {
        legendElement = _react2.default.createElement(
          ...
          _react2.default.createElement(_Legend2.default, { series: series, units: 'asdasdaunits', total: true,
